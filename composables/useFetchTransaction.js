...
export const useFetchTransactions = (period) => {
  ...
  const income = computed(() => transactions.value.filter((t) => t.type === TRANSACTION_TYPES.INCOME));
  const expense = computed(() => transactions.value.filter((t) => t.type === TRANSACTION_TYPES.EXPENSE));
